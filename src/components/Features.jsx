    ...
    <section className='bg-black pb-52'>
        ...
        <div className='container mx-auto px-3 md:px-10'>
            ...
            <div className='px-5 py-32'>
                <p className='font-circular-web text-lg text-blue-50'>Into the MetaGame player</p>
                <p className='max-w-md font-circular-web text-lg text-blue-50 opacity-50'>Immerse yourself in a rich and ever-expanding universe where a vibrant array of products converge into and interconnected overlay experience on your world.</p>
            </div>
            {/* Bento grid */}
